...
public class ActividadesDeportivasYCulturales {
    public static void Menu() {
        ImprimirNombre();
        int mostrar = menu(Datos.opcionesDeportivas);
        switch (mostrar) {
            case 0:
                System.out.println("error");
                break;
            default:
                System.out.println(Datos.mensajeDeportivas[mostrar - 1]);
                break;
        }
    }
    ...
    public static void printlnColor(String linea){
        String colorTexto = "\u001B[38;2;176;245;27m";
